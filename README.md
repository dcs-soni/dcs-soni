...
| -------- | --------- | ------------------------- |
| 📦 **87** public repos | 🔥 **1,217** commits | ![TypeScript](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%233178c6&message=TypeScript%2076%25) |
| 🔥 **2,476** commits | 📝 **4** issues | ![JavaScript](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%23f1e05a&message=JavaScript%2013%25) |
...
| 🔀 **454** PRs | ![+248,836](https://img.shields.io/static/v1?style=plastic&label=&color=brightgreen&message=%2B248%2C836) lines added | ![CSS](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%23663399&message=CSS%204%25) |
| ⭐ **35** stars | ![-55,402](https://img.shields.io/static/v1?style=plastic&label=&color=red&message=-55%2C402) lines removed | ![HCL](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%23844FBA&message=HCL%201%25) |
...
- [dcs-soni](https://github.com/dcs-soni/dcs-soni) - 68 commits, ![+3,569](https://img.shields.io/static/v1?style=plastic&label=&color=brightgreen&message=%2B3%2C569) ![-821](https://img.shields.io/static/v1?style=plastic&label=&color=red&message=-821) - *No description provided.*
...
- [promptenhance](https://github.com/dcs-soni/promptenhance) - Add relevant code context to your AI prompts using semantic search and vector embeddings. `TypeScript` · Updated 2 days ago
- [stashit-cloud](https://github.com/dcs-soni/stashit-cloud) - Save, search, and share your content intelligently with AI-powered semantic search and shareable links. `TypeScript` · Updated 2 days ago
- [postmaster](https://github.com/dcs-soni/postmaster) - A lightweight, secure API testing tool with a built-in CORS proxy server to test HTTP endpoints directly from your browser without restrictions. `TypeScript` · Updated 5 days ago
- [cabo](https://github.com/dcs-soni/cabo) - Real-time multiplayer Cabo card game. `TypeScript` · Updated 6 days ago
- [gitscribe](https://github.com/dcs-soni/gitscribe) - AI-powered CLI for generating conventional commits, changelogs, and release notes using LLMs. `TypeScript` · Updated 6 days ago
- [curl-to-code](https://github.com/dcs-soni/curl-to-code) - No description `TypeScript` · Updated 1 week ago
- [assets](https://github.com/dcs-soni/assets) - No description `—` · Updated 3 weeks ago
- [promptdiff](https://github.com/dcs-soni/promptdiff) - No description `TypeScript` · Updated 3 weeks ago
- [build-track](https://github.com/dcs-soni/build-track) - A multi-tenant construction management platform to streamline projects, budgets, RFIs, and equipment tracking. `TypeScript` · Updated 1 month ago
