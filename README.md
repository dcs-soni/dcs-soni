...
| -------- | --------- | ------------------------- |
| 📦 **87** public repos | 🔥 **1,220** commits | ![TypeScript](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%233178c6&message=TypeScript%2076%25) |
| 🔥 **2,483** commits | 📝 **4** issues | ![JavaScript](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%23f1e05a&message=JavaScript%2013%25) |
...
| 🔀 **454** PRs | ![+250,952](https://img.shields.io/static/v1?style=plastic&label=&color=brightgreen&message=%2B250%2C952) lines added | ![CSS](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%23663399&message=CSS%203%25) |
| ⭐ **35** stars | ![-55,564](https://img.shields.io/static/v1?style=plastic&label=&color=red&message=-55%2C564) lines removed | ![HCL](https://img.shields.io/static/v1?style=plastic&label=%E2%A0%80&color=555&labelColor=%23844FBA&message=HCL%201%25) |
...
- [dcs-soni](https://github.com/dcs-soni/dcs-soni) - 69 commits, ![+3,581](https://img.shields.io/static/v1?style=plastic&label=&color=brightgreen&message=%2B3%2C581) ![-833](https://img.shields.io/static/v1?style=plastic&label=&color=red&message=-833) - *No description provided.*
- [vault-key](https://github.com/dcs-soni/vault-key) - 60 commits, ![+16,282](https://img.shields.io/static/v1?style=plastic&label=&color=brightgreen&message=%2B16%2C282) ![-1,336](https://img.shields.io/static/v1?style=plastic&label=&color=red&message=-1%2C336) - *A zero-knowledge password manager with AES-256 client-side encryption and loc...*
...
- [notion-image-cdn](https://github.com/dcs-soni/notion-image-cdn) - 44 commits, ![+17,828](https://img.shields.io/static/v1?style=plastic&label=&color=brightgreen&message=%2B17%2C828) ![-5,492](https://img.shields.io/static/v1?style=plastic&label=&color=red&message=-5%2C492) - *Image proxy + CDN for Notion-powered websites.*
...
- [promptenhance](https://github.com/dcs-soni/promptenhance) - Add relevant code context to your AI prompts using semantic search and vector embeddings. `TypeScript` · Updated 3 days ago
- [stashit-cloud](https://github.com/dcs-soni/stashit-cloud) - Save, search, and share your content intelligently with AI-powered semantic search and shareable links. `TypeScript` · Updated 3 days ago
- [postmaster](https://github.com/dcs-soni/postmaster) - A lightweight, secure API testing tool with a built-in CORS proxy server to test HTTP endpoints directly from your browser without restrictions. `TypeScript` · Updated 6 days ago
...
- [promptdiff](https://github.com/dcs-soni/promptdiff) - No description `TypeScript` · Updated 4 weeks ago
